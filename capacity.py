...
from data.random_vector_datasets import RandomVectorDataset
...
from models.spiking_model import SpikingProtoNet, RandomVectorSpikingProtoNet
...
def main_worker(gpu, num_gpus_per_node, args):
    ...
    test_set = RandomVectorDataset(sequence_length=args.sequence_length, num_classes=args.num_classes,
    ...
    if args.use_pretrained_protonet:
        ...
        image_embedding_layer = RandomVectorSpikingProtoNet(IafPscDelta(thr=0.05,
        ...
        # Create ProtoNet
        image_embedding_layer = RandomVectorSpikingProtoNet(IafPscDelta(thr=args.thr,
                                                            perfect_reset=args.perfect_reset,
                                                            refractory_time_steps=args.refractory_time_steps,
                                                            tau_mem=args.tau_mem,
                                                            spike_function=SpikeFunction,
