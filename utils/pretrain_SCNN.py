...
parser.add_argument('--dir', default='/usr/common/datasets/MNIST', type=str, metavar='DIR',
...
def main_worker(gpu, num_gpus_per_node, args):
    ...
    if args.audio:
        ...
        #                                       download=True, transform=image_transform)
        train_set = torchvision.datasets.MNIST(root=args.dir, train=True,
                                               download=True, transform=image_transform)

        test_set = torchvision.datasets.MNIST(root=args.dir, train=False,
                                              download=True, transform=image_transform)
